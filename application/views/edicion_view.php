...
<html>
	...
	<body>
		<h1>Editar cosa</h1>
		<form action="<?php echo base_url(); ?>/EdicionCosa/updatear/<?php echo $cosa->id; ?>" method="POST">
			<label for="nombre">Nombre:</label>
			<input type="text" name="nombre" id="nombre" value="<?php echo $cosa->nombre?>">
			<br>
			<label for="cantidad">Cantidad:</label>
			<input type="number" name="cantidad" id="cantidad" value="<?php echo $cosa->cantidad;?>">
			<br><br>
